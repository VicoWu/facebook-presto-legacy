...
{
    @Inject
    public MsSqlClient(JdbcConnectorId connectorId, BaseJdbcConfig config)
            throws SQLException
    {
    ...
    {
        // for MsSQL, we need to list catalogs instead of schemas
    ...
    protected ResultSet getTables(Connection connection, String schemaName, String tableName)
            throws SQLException
    {
        // MsSQL maps their "database" to SQL catalogs and does not have schemas
    ...
    protected SchemaTableName getSchemaTableName(ResultSet resultSet)
            throws SQLException
    {
        // MsSQL uses catalogs instead of schemMsSqlClientas
